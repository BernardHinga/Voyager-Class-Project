...
<?php include('includes/header.php');?>
    ...
    <div class="page-pagi">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item"><a class="page-link" href="gallery4.html">Previous</a></li>
                ...
                <div class="col-lg-12">
                    <div class="car-list-content">
                        <div class="row">
                            ...
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="s60">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/volvo-s60.jpg" alt="Volvos60">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLVO S60</a></h2>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="xc40">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/volvo-xc40.jpg" alt="Volvoxc40">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLVO XC40</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>AWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="xc60">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/volvo-xc60.jpg" alt="Volvoxc60">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLVO XC60</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>RWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="golf">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/vw-golf.jpg" alt="VWgolf">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLKSWAGEN GOLF TSI</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>AWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="gti">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/vw-gti.jpg" alt="VWgti">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLKSWAGEN GOLF GTI</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>AWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="jetta">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/vw-jetta.jpg" alt="VWjetta">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLKSWAGEN JETTA</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>AWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="passat">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/vw-passat.jpg" alt="VWpassat">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLKSWAGEN PASSAT</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>AWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="polo">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/vw-polo.jpg" alt="VWpolo">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLKSWAGEN POLO</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>AWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="tiguan">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/vw-tiguan.png" alt="VWtiguan">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLKSWAGEN TIGUAN</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>AWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="toureg">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/vw-toureg.jpg" alt="VWtoureg">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">VOLKSWAGEN TOUREG</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>RWD</li>
