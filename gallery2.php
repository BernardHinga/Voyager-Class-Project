                ...
                <div class="col-lg-12">
                    <div class="car-list-content">
                        <div class="row">
                            ...
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="lx570">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/lexus-lx570.jpg" alt="Lexuslx570">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">LEXUS LX570</a></h2>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="rx350">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/lexus-rx350.jpg" alt="Lexusrx350">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">LEXUS RX350</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>RWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="mazda2">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/mazda-2.jpg" alt="Mazda2">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">MAZDA 2</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>RWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="mazda3">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/mazda-3.jpg" alt="Mazda3">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">MAZDA 3</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>AWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="c200">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/merc-c200.png" alt="Mercc200">
                                    </div>
                                    <div class="car-list-info without-bar">
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="c300">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/merc-c300.jpg" alt="Mercc300">
                                    </div>
                                    <div class="car-list-info without-bar">
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" i="cla">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/merc-cla.jpg" alt="Merccla">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">MERCEDES CLA</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>RWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="cls">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/merc-cls.jpg" alt="Merccls">
                                    </div>
                                    <div class="car-list-info without-bar">
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="e63">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/merc-e63.jpg" alt="Merce63">
                                    </div>
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#">MERCEDES E63</a></h2>
                                        <h5>3500 k/sh Rent /per a day</h5>
                                        <p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean inorci luctus et ultrices posuere cubilia.</p>
                                        <ul class="car-info-list">
                                            <li>AWD</li>
                            ...
                            <!-- Single Car End -->
                            <!-- Single Car Start -->
                            <div class="col-lg-6 col-md-6" id="e350">
                                <div class="single-car-wrap">
                                    <div class="car-list-thumb car-thumb-1">
                                        <img src="img/cars/merc-e350.jpg" alt="Merce350">
                                    </div>
                                    <div class="car-list-info without-bar">
